...
import {faGlobe, faUser, faPalette} from "@fortawesome/free-solid-svg-icons";
        ...
        <>
            { props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                    ...
                    <Nav.Item><Nav.Link as={Link} to="/my"><FontAwesomeIcon icon={faUser} />{' '}Мой аккаунт</Nav.Link></Nav.Item>
            ...
            { !props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                    ...
                    <Nav.Item><Nav.Link as={Link} to="/my"><FontAwesomeIcon icon={faUser} size="2x" /></Nav.Link></Nav.Item>
                </Nav>
            }
        </>
    )
